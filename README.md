...
<p>
  Software Developer with a passion for innovation and technology, thoughtful UI designs, collaborating, and learning from my team members. I have 4+ years of experience in software development, building responsive websites/web applications, mobile applications, and interactive features that drive and improve user experience as well as scalable software solutions. 
</p>
<p>
  I am proficient in HTML/CSS/SCSS, Bootstrap, Tailwind CSS, JavaScript, PHP (Laravel), Node JS, MySQL, Postgres, Sqlite, Dart/Flutter, WordPress, Figma, Canva. In addition, I have Knowledge of Python (Django), React Native, MongoDB, Firebase and exceptional problem-solving skills that allow me to tackle intricate challenges.
</p>
<p>
...
![](https://komarev.com/ghpvc/?username=cycosad&color=0066ff)
